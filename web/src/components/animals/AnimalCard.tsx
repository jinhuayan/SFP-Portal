...
const AnimalCard: React.FC<AnimalCardProps> = ({ 
  ...
  return (
    <div className={cn("bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col", className)}>
      {/* Animal Image */}
