    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">{animal.name}</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">{animal.breed}</p>
          </div>
          
          <div className="flex gap-3">
            <div className={`flex items-center justify-center h-16 w-16 rounded-full ${
              animal.sex === 'Male' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300' : 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
            ...
            <p className="text-xl font-semibold text-gray-800 dark:text-white">{animal.age}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Color</h3>
            <p className="text-xl font-semibold text-gray-800 dark:text-white">{animal.color}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Location</h3>
            <p className="text-xl font-semibold text-gray-800 dark:text-white line-clamp-1">{animal.location}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Adoption Fee</h3>
           <p className="text-xl font-semibold text-[#4C51A4]">${animal.adoptionFee}</p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <span className="text-gray-700 dark:text-gray-300">{daysInSFP} days in SFP</span>
            </div>
            <div className="flex items-center">
              <i className="fa-solid fa-location-dot text-[#4C51A4] mr-3"></i>
              <span className="text-gray-700 dark:text-gray-300">Located at {animal.location}</span>
            </div>
          </div>
        </div>
        ...
        {/* Description */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">About {animal.name}</h2>
        ...
        {/* Compatibility */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Compatibility</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center">
                <i className={`fa-solid fa-child text-xl mr-3 ${
                ...
                <div>
                  ...
                  <p className={`text-sm ${
                    ...
                    {animal.goodWith.children ? 'Good with kids' : 'Not recommended for kids'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center">
                <i className={`fa-solid fa-dog text-xl mr-3 ${
                  animal.goodWith.dogs ? 'text-green-500' : 'text-red-500'
                }`}></i>
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-white">Other Dogs</h3>
                  <p className={`text-sm ${
                    animal.goodWith.dogs 
                      ? 'text-green-600 dark:text-green-400' 
                      : 'text-red-600 dark:text-red-400'
                  }`}>
                    {animal.goodWith.dogs ? 'Good with other dogs' : 'Prefers to be the only pet'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center">
                <i className={`fa-solid fa-cat text-xl mr-3 ${
                  animal.goodWith.cats ? 'text-green-500' : 'text-red-500'
                }`}></i>
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-white">Cats</h3>
                  <p className={`text-sm ${
                    animal.goodWith.cats 
                      ? 'text-green-600 dark:text-green-400' 
                      : 'text-red-600 dark:text-red-400'
                  }`}>
                    {animal.goodWith.cats ? 'Good with cats' : 'Not compatible with cats'}
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Health Info */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Health</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              <i className={`fa-solid text-xl mr-3 ${
                animal.vaccinated ? 'text-green-500' : 'text-red-500'
              }`}>
                {animal.vaccinated ? '✓' : '✗'}
              </i>
              <span className="text-gray-700 dark:text-gray-300">Vaccinated</span>
            </div>
            <div className="flex items-center">
              <i className={`fa-solid text-xl mr-3 ${
              ...
              <span className="text-gray-700 dark:text-gray-300">Neutered/Spayed</span>
            </div>
          </div>
        </div>
        ...
        {animal.status === 'Adopted' && (
          <div className="flex justify-center">
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-500 rounded-lg p-4 text-center w-full max-w-md">
              ...
              <h3 className="text-xl font-bold text-green-800 dark:text-green-300 mb-2">Successfully Adopted!</h3>
        ...
        {animal.status === 'Reserved' && (
          <div className="flex justify-center">
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-500 rounded-lg p-4 text-center w-full max-w-md">
              ...
              <h3 className="text-xl font-bold text-yellow-800 dark:text-yellow-300 mb-2">Pending Adoption</h3>
