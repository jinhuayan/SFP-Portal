...
export default function Home() {
  ...
  useEffect(() => {
    const fetchHomeData = async () => {
      try {
        // Fetch featured published animals (public endpoint)
        const publishedAnimals = await apiGet("/api/animals/available");
        const featured = publishedAnimals.slice(0, 3);
        setFeaturedAnimals(featured);

        // Fetch adopted animals for success stories (public endpoint)
        const adoptedAnimals = await apiGet("/api/animals/adopted");
        const stories = adoptedAnimals.slice(0, 2);
        setSuccessStories(stories);

        // Fetch total animals count
        const animalsCountRes = await apiGet("/api/animals/stats/total");

        // Fetch total volunteers count
        const volunteersCountRes = await apiGet("/api/volunteers/stats/total");

        // Calculate stats
        setStats({
          totalAnimals: animalsCountRes.count,
          adoptedAnimals: adoptedAnimals.length,
          volunteersCount: volunteersCountRes.count,
        });
      } catch (error) {
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4 z-10 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto drop-shadow-md">
                Save Fur Pets connects loving homes with animals in need. Browse
                our adoptable pets and start your journey together.
              </p>
        ...
        <section className="py-16 bg-[#FFDF4] dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
                  These animals are currently looking for their forever homes.
                  Click on any pet to learn more about them.
                </p>
              </div>
              <Link
                to="/adoptables"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {featuredAnimals.map((animal: any, index) => (
                <motion.div
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/70 to-transparent">
                        ...
                        <p className="text-white/80">{animal.species}</p>
                    ...
                    <div className="p-4 flex-1 flex flex-col">
                      ...
                      <div className="flex flex-wrap gap-1.5 mb-4">
                        {animal.personality &&
                        Array.isArray(animal.personality) &&
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
                  See how our rescued animals have found their forever homes and
                  brought joy to their new families.
                </p>
              </div>
              <Link
                to="/adopted"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {successStories.map((animal: any, index) => (
                <motion.div
                  key={animal.unique_id}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                    ...
                    <div className="p-4 flex-1 flex flex-col">
                      <p className="text-gray-700 dark:text-gray-300 text-sm mb-4 line-clamp-3">
                        {animal.description || "Success story coming soon!"}
                      </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Our simple four-step process makes finding your perfect
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  title: "Apply",
                  description:
                    "Submit an adoption application and our team will review it promptly.",
                },
                {
                  icon: "fa-calendar-check",
                  title: "Interview",
                  description:
                    "Schedule an interview for your potential new family member.",
                },
                {
                  icon: "fa-home",
                  title: "Welcome Home",
                  description:
                    "Complete the adoption process and welcome your new pet to their forever home.",
                },
              ].map((step, index) => (
                <motion.div
                  key={index}
