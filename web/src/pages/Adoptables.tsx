...
export default function Adoptables() {
  ...
  // Build filter configuration based on active tab
  const activeFilters = useMemo(() => {
    ...
    switch (activeTab) {
      ...
      case "small":
        ...
        break;
      case "petsmart":
        filters.location = "PetSmart";
        break;
      case "petvalu":
        filters.location = "PetValu";
        break;
      case "senior":
        // Senior pets - typically older animals (age > 5 years)
        filters.age = "Senior";
        break;
      case "all":
      default:
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Browse our available animals and find your perfect companion. All
            our pets are vaccinated, neutered, and ready to join their new
            families.
          </p>
        </motion.div>
